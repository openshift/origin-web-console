...
angular.module("openshiftConsole")
  .factory("HTMLService", function($sanitize) {
    return {
      ...
      linkify: function(text, target, alreadyEscaped) {
        ...
        var markup = text.replace(/https?:\/\/[A-Za-z0-9._%+-]+\S*[^\s.;,(){}<>"\u201d\u2019]/gm, function(str) {
          if (target) {
        ...
        try {
          ...
          // $sanitize will throw an error on invalid HTML. Fall back to the text without links.
          return text;
        }
