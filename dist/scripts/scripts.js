...
function OverviewController(e, t, n, a, r, o, i, s, c, l, u, d, m, p, g, f, h, v, y, b, S, C, w, P, j, k, I, T, R, A, N, E) {
function D(e) {
...
Se.podsByOwnerUID = j.groupByOwnerUID(L.pods), L.monopods = _.filter(Se.podsByOwnerUID[""], at), B();
}, ot = function(e) {
...
}), L.pipelineBuildConfigs = _.sortBy(e, "metadata.name"), Ne(), nt(L.pipelineBuildConfigs), Ee();
}, wt = function() {
...
k.get(r.project, At).then(_.spread(function(t, a) {
...
Rt.push(m.watch(N.offlineVirtualMachine, a, function(e) {
L.offlineVirtualMachines = e.by("metadata.name"), B(), Oe();
}, {
poll: V,
pollInterval: 6e4
}));
Rt.push(m.watch(N.virtualMachine, a, function(e) {
...
var t = A.getServiceClassNameForInstance(e);
if (!t) return n.when();
...
var t = A.getServicePlanNameForInstance(e);
if (!t) return n.when();
...
". You cannot create new storage since you are at quota.": ". 你无法创建新存储因为配额不足.",
"(Build and Runtime)": "(Build和Runtime)",
...
"A file will be created in this directory for each key from the config map or secret. The file contents will be the value of the key.": "在该目录下将给每个来自config map或者secret的key创建一个文件。 文件内容将是密钥的值。",
"A Git repository URL is required.": "Git仓库URL是必选项。",
"A Jenkinsfile is a Groovy script that defines your pipeline. In the Jenkinsfile, you can declare pipeline stages and run one or more steps within each stage. Here are some examples you can use in your pipelines.": "Jenkinsfile是一个定义pipeline的Groovy脚本。 在Jenkinsfile中，您可以声明pipeline阶段并在每个阶段中运行一个或多个步骤。 以下是您可以在pipelines使用的一些示例。",
"A liveness probe checks if the container is still running. If the liveness probe fails, the container is killed.": "Liveness probe检查容器是否仍在运行。 如果Liveness probe失败，容器会被杀死。",
"a mistyped address": "一个错误的地址",
"A name is required.": "名称是必选项.",
"A new deployment will start automatically when": "新deployment将自动启动当",
"A persistent volume claim is required to attach to this": "Persistent volume claim需要挂载到",
"A project is required in order to complete the installation.": "需要指定一个项目才能完成安装。",
"A readiness probe checks if the container is ready to handle requests. A failed readiness probe means that a container should not receive any traffic from a proxy, even if it's running.": "Readiness probe检查容器是否准备好处理请求。探测出失败意味着容器不应接收任何来自代理的流量，即使它正在运行。",
...
"A value for replicas is required.": "replicas值是必选项。",
"Abort deployment on failure": "失败时中止deployment",
About: "关于",
...
"Always pull the builder image from the docker registry, even if it is present locally": "始终从docker registry中拉取builder镜像，即使它在本地存在",
...
"An error occurred creating the horizontal pod autoscaler.": "创建horizontal pod autoscaler时出错.",
"An error occurred creating the project.": "创建项目出错.",
"An error occurred creating the route.": "创建路由出错.",
"An error occurred deleting the binding.": "删除binding时发生错误。",
...
"An error occurred scaling the deployment config.": "扩展deployment config时发生错误。",
"An error occurred scaling the deployment.": "扩展deployment时发生错误。",
"An error occurred scaling.": "扩缩容发生错误。",
"An error occurred starting the debug pod.": "启动调试pod时发生错误。",
"An error occurred updating build config {{name}}.": "更新build config{{name}}时发生错误。",
"An error occurred updating deployment config {{name}}.": "更新deployment config{{name}}时发生错误。",
"An error occurred updating environment variables for {{kind}} {{name}}.": "为 {{kind}} {{name}}更新环境变量出现错误.",
"An error occurred updating environment variables for build config {{name}}.": "更新build config{{name}}的环境变量时发生错误。",
"An error occurred updating metrics for pod {{pod}}.": "为pod {{pod}}更新指标出现错误.",
"An error occurred updating metrics.": "更新计量数据时发生错误.",
...
"An image stream or template is required.": "image stream或模板是必选项.",
"An image that can carry out the deployment.": "可以执行deployment的镜像。",
"an out-of-date link": "一个过期的链接",
and: "和",
"and any running pods.": "以及任何正在运行的pod。",
"and its data will no longer be available to your applications.": "并且您的应用程序将无法再使用其数据。",
"and the": "和",
"Any remaining build history for this build will be shown.": "将显示此版本的任何剩余build历史记录。",
"Any remaining deployment history for this deployment will be shown.": "将显示此deployment的任何剩余deployment历史记录。",
Application: "应用",
...
"Automatically build a new image when the builder image changes": "builder image变化时自动生成新镜像",
"Automatically building a new image when the builder image changes allows your code to always run on the latest updates.": "在builder image更改时自动building新镜像允许代码始终在最新更新上运行。",
"Automatically start a new deployment when the deployment configuration changes": "deployment配置更改时自动启动一个新的deployment流程",
"Automatically start a new deployment when the image changes": "镜像更改时自动启动新的deployment",
"Autoscaler Name": "Autoscaler名称",
"Autoscaling is not enabled. There are no autoscalers for this": "Autoscaling没有开启，没有autoscalers适用",
"Autoscaling is not enabled. There are no autoscalers for this deployment config.": "Autoscaling没有开启，没有autoscalers适用部署deployment config。",
"Autoscaling not supported for kind {{kind}}.": "Autoscaling不支持 {{kind}}类型。",
available: "可用",
"Available of": "可提供",
Average: "平均",
"Average build duration {{averageDurationText}}": "平均build持续时间{{averageDurationText}}",
"Average Duration": "平均持续时间",
"Average per pod": "每个pod的平均值",
"Average Usage": "平均使用率",
Back: "返回",
"Back to": "返回",
"Back to catalog": "返回catalog",
"Back to overview": "返回概况",
"Basic CLI Operations": "基本CLI操作",
"Binary Input as File:": "二进制文件输入：",
"Binary Units": "二进制单位",
"Binding for the following has been deleted:": "已删除以下Binding：",
"Bitbucket Webhook URL:": "Bitbucket Webhook网址：",
Browse: "浏览",
"Browse Catalog": "浏览Catalog",
...
"Build hooks allow you to run commands at the end of the build to verify the image.": "Build hooks 允许您在build结束时运行命令以验证镜像。",
"Build Strategy": "Build策略",
"Build Strategy:": "Build策略：",
"Builder Image:": "Builder镜像:",
"Builds source code": "Builds源码",
"Builds triggered from this Build Configuration will run all at the same time. The order in which they will finish is not guaranteed.": "从Build Configuration触发的Builds将同时运行。 他们的完成顺序无法保证。",
"Builds triggered from this Build Configuration will run one at the time, in the order they have been triggered.": "从Build Configuration触发的Builds将按照它们被触发的顺序逐个运行。",
"Builds triggered from this Build Configuration will run one at the time. When a currently running build completes, the next build that will run is the latest build created. Other queued builds will be cancelled.": "从此Build Configuration触发的Builds将逐个运行。当前正在运行的构建完成时，下一个即将运行的build是最新创建的那个。其他排队的build将被取消。",
"Builds triggered from this Build Configuration will run using the": "从该Build Configuration触发的Builds将使用",
...
"Cannot create": "无法创建",
"Cannot create from source: a base image tag was not specified": "无法从source中创建：基础镜像的tag未指定",
"Cannot create from source: a base image was not specified": "无法从source中创建：基础镜像的tag未指定",
"Cannot create from source: the specified image could not be retrieved.": "无法从source中创建：指定的镜像无法取得。",
...
Capacity: "容量",
"Capacity:": "容量：",
"Catalog category {{category}} not found.": "找不到Category类别{{category}}。",
"Catalog category {{category}}/{{subcategory}}not found.": "未找到Catalog类别{{category}} / {{subcategory}}。",
"Catalog Home (Default)": "Catalog主页（默认）",
Certificate: "证书",
"Certificate:": "证书：",
Certificates: "证书",
change: "改变",
"Change Of:": "改变",
"Changes will only apply to new pods.": "更改仅会应用于新的pods。",
"Check events": "检查事件",
...
"Choose a resource": "选择一个资源",
"Choose a resource to list...": "选择一个资源到列表…",
...
"Config map {{configMap.metadata.name}} has changed since you started editing it.You'll need to copy any changes you've made and edit the config map again.": "自您开始编辑后，Config map{{configMap.metadata.name}}已更改。您需要复制您所做的任何更改并再次编辑config map。",
...
"Confirm Delete": "确认删除",
"Confirm Login": "确认登陆",
"Confirm on exit prompt appears to have been blocked by the browser.": "退出提示的确认窗口已被浏览器阻止。",
...
"Continue to the project overview": "跳转至项目概况",
"Continue with deployment on failure": "失败继续deployment",
...
"Create or replace resources from their YAML or JSON definitions. If adding a template, you'll have the option to process the template.": "从YAML或JSON定义创建或替换资源。 如果添加模板，您将拥有处理模板的选项。",
"Create Project": "创建项目",
"Create Route": "创建路由",
...
"Delay can't be negative.": "延迟数值不能是负数。",
"delay,": "延迟，",
delete: "删除",
Delete: "删除",
...
"deployment config or deployment.": "deployment config或deployment。",
"Deployment configuration changes": "Deployment configuration变化",
"deployment strategy": "deployment策略",
"Deployment Strategy": "Deployment策略",
"deployment trigger": "Deployment触发",
...
Details: "详情",
"Directory where the files will be available at build time.": "文件在build时可用的目录。",
Dismiss: "丢弃",
"Display Name": "显示名称",
...
"documentation.": "文档。",
"does not have any containers with a CPU": "没有任何带CPU Request设置的容器",
...
Duration: "持续时间",
"Duration:": "持续时间：",
"Each container running on a node uses compute resources like CPU and memory. You can specify how much CPU and memory a container needs to improve scheduling and performance.": "在节点上运行的每个容器都使用CPU和内存等计算资源。你可以指定容器需要多少CPU和内存来改善调度和性能。",
Edit: "编辑",
...
"Enter a value for the {{type}} entry or use the contents of a file.": "输入{{type}} entry的值或使用文件的内容。",
...
"Enter the command to run inside the container. The command is considered successful if its exit code is 0. Drag and drop to reorder arguments.": "输入要在容器内运行的命令。 如果命令被认为是成功，退出代码为0。拖放以重新排序参数。",
Environment: "环境",
"Environment From": "环境来自",
"Environment variables": "环境变量",
"Environment Variables": "环境变量",
"Environment variables are used to configure and pass information to running containers.  These environment variables will be available during your build and at runtime.": "环境变量用于配置信息并将信息传递给正在运行的容器。 这些环境变量将在build期间和运行时可用。",
"Environment variables can be edited on deployment config": "可以在deployment config配置上编辑环境变量",
"Environment variables can be edited on the": "编辑环境变量可被编辑在",
"Environment variables can be edited on the deployment": "可以在deployment中编辑环境变量",
...
"External IP": "外网IP",
"External IPs:": "外网IP：",
"Fail the deployment if the hook fails.": "如果hook失败，则deployment失败。",
failed: "失败",
...
"Filter by name or description": "按名称或描述过滤",
Follow: "跟随",
"For other information about the command line tools, check the": "有关命令行工具的其他信息，请查看",
"for source, routes, builds, and deployments.": "用于资源，路由，build和deployments。",
"from image": "来自镜像",
...
"If not specified, a hostname is generated.": "如果未指定，则自动生成一个主机名。",
...
"If this is unexpected, click Cancel. This could be an attempt to trick you into acting as another user.": "如果这是您意料之外的，请单击“取消”。 这可能是一种诱骗攻击。",
...
"Ignore hook failures and continue the deployment.": "忽略hook故障并继续deployment。",
Image: "镜像",
"Image {{import.name}} runs as the root user which might not be permitted by your cluster administrator.": "Image{{import.name}}以root运行，群集管理员可能不允许以root运行。",
"Image change": "镜像变化",
"Image Configuration": "镜像配置",
"Image Environment Variables": "镜像环境变量",
"Image Name": "镜像名称",
"Image Registry Server Address": "Image Registry Server地址",
"Image registry server address is required.": "Image registry服务器地址是必选项。",
...
Min: "最小",
"Min Pods": "Pods数最小值",
"Min pods must be a number.": "Pods数最小值必须是一个数字。",
"Min pods must be a whole number.": "Pods数最小值必须是一个整数。",
"Min pods must be greater than or equal to 1.": "Pods数最小值必须大于或等于1。",
"min pods, which is": "Pods数最小值，是",
"Min Pods:": "Pods数最小值：",
"Min Ready:": "Ready最小值：",
"min:": "最小值",
...
"No deployments to show": "没有可显示的deployments",
"No deployments.": "无deployments。",
...
"No layer information is available for this image.": "此镜像没有可用的layer信息。",
...
"Note: This setting is browser-specific and will not be maintained across browsers.": "注意：此设置是特定于浏览器的，不会跨浏览器保持。",
Notifications: "通知",
"one of the images referenced by this deployment config changes.": "此deployment config修改引用其中一个images。",
"Only the first {{limitListTo}} projects are displayed.Filter by keyword or change sort options to see other projects.": "仅显示第一个{{limitListTo}}项目。按关键字过滤或更改排序选项以查看其他项目。",
...
"Optional path to the Jenkinsfile relative to the context dir.Defaults to the Jenkinsfile in context dir.": "相对于context dir的Jenkinsfile可选路径。默认为context dir中的Jenkinsfile。",
"Optional path within the volume from which it will be mounted into the container. Defaults to the volume's root.": "将挂载到容器的卷中的可选路径。默认为卷的根目录。",
...
"Password or token is required.": "密码或token是必选项。",
Path: "路径",
...
Ports: "端口",
"Ports:": "端口：",
"Post hooks execute after the deployment strategy completes.": "在deployment策略完成后执行Post hooks 。",
"Pre hooks execute before the deployment begins.": "在deployment开始之前执行预hooks。",
Prefix: "前缀",
...
"Remove volume{{name}}?": "移除卷 {{name}}?",
Replace: "替换",
"replica count and selector": "replica计数和选择器",
...
"Run an OpenShift build and deployment:": "运行OpenShiftbuild和deployment：",
"Run build hooks after image is built": "build镜像后运行build hooks",
"Run Policy": "运行策略",
"Run policy type": "运行策略类型",
"Run Policy:": "运行策略：",
"Runs a command in a new pod using the container from the deployment template. You can add additional environment variables and volumes.": "使用deployment模板中的容器在新pod中运行命令。 您可以添加其他环境变量和卷。",
"runs after the deployment strategy completes": "deployment策略完成后运行",
"runs after the previous deployment is scaled down to zero and before the first pod of the new deployment is created": "运行在之前的deployment缩容到零之后，并且在新deployment创建第一个pod之前",
"runs before the deployment begins": "运行在deployment开始之前",
Save: "保存",
...
"Select an item to add to the current project": "选择一项添加到当前项目中",
...
"Select storage to use.": "选择要使用的存储",
"Select the keys to use and the file paths where each key will be exposed.The file paths are relative to the mount path.The contents of each file will be the value of the key.": "选择要使用的keys以及将公开每个keys的文件路径。文件路径相对于挂载路径。每个文件的内容都是key的值。",
Selection: "选择",
Selector: "选择者",
"Selector:": "选择：",
"Selectors:": "选择：",
...
"Service {{model.name}} has a single, unnamed port. A route cannot specifically target an unnamed service port. If more service ports are added later, the route will also direct traffic to them.": "Service {{model.name}}有一个未命名的端口。 路由无法专门定位一个未命名的服务端口。 如果稍后添加更多服务端口，则路由也将引导流量给他们。",
...
"source code will be built and deployed unless otherwise specified in the next step.": "除非在下一步中另有说明，否则将build和部署源代码。",
"Source Commit:": "来源提交：",
...
"Source Repository:": "源仓库：",
"Source secret to copy into the builder pod at build time.": "在build时复制到builder pod中的Source secret 。",
"Source secret to mount into the builder pod at build time.": "在build时挂载到 builder pod中的Source secret。",
...
"Tag As": "标记为",
"Tag image if the deployment succeeds": "如果deployment成功，则标记图像",
Tags: "标记",
"Tags the current image as an image stream tag if the deployment succeeds.": "如果deployment成功，则将当前image标记为image stream tag。",
...
"The build run policy describes the order in which the builds created from the build configuration should run.": "build运行策略描述了从build配置创建的build应该运行的顺序。",
"The build strategy had no environment variables defined.": "build策略没有定义环境变量。",
...
"The complete list of your projects could not be loaded.Type a project name to go to that project.": "无法加载完整的项目列表。输入要转到该项目的项目名称。",
...
"The custom strategy allows you to specify container image that will provide your own deployment behavior.": "自定义策略允许您指定将提供您自己的deployment行为的容器镜像。",
...
"The deployment controlling this replica set has been deleted.": "控制replica set的deployment已被删除.",
"The deployment details could not be loaded.": "deployment详情无法被加载.",
"The destination CA certificate will be removed from the route.Destination CA certificates are only used for re-encrypt termination.": "目标CA证书将从路由中删除。目标CA证书仅用于re-encrypt termination。",
...
"The lower limit for the number of pods that can be set by the autoscaler.If not specified, defaults to 1.": "自动扩容可以设置的pod数量的下限。如果未指定，则默认为1。",
...
"The maximum number of pods that can be scheduled above the original number of pods while the rolling deployment is in progress. This can be either a percentage (10%) or a whole number (1).": "Rolling deployment正在进行时，可以在原始pod数量之上调度的最大pod数。 这可以是百分比（10％）或整数（1）。",
"The maximum number of pods that can be unavailable during the rolling deployment. This can be either a percentage (10%) or a whole number (1).": "Rolling deployment期间可用的最大pod数。 这可以是百分比（10％）或整数（1）。",
"The maximum web console log size has been reached. Use the command-line interface or": "已达到Web控制台日志长度的上限值。请使用命令行接口或",
...
"The percentage of the CPU request that each pod should ideally be using.Pods will be added or removed periodically when CPU usage exceeds or drops below this target value.": "理想情况下每个pod应使用的CPU请求百分比。 当CPU使用率超过或低于此目标值时，将定期添加或删除Pod。",
...
"The recreate strategy has basic rollout behavior and supports lifecycle hooks for injecting code into the deployment process.": "重新创建策略具有基本的rollout行为，并支持生命周期钩子，用于将代码注入deployment过程。",
...
"The route is unsecured.": "该路由是非安全的。",
...
"There are no notifications to display.": "没有要显示的通知。",
...
"There are no service bindings.": "没有service bindings。",
...
"This build configuration can not be found, it may have been deleted.": "无法找到此build configuration，它可能已被删除。",
"This build configuration has been deleted.": "build configuration已被删除.",
"This build configuration has been updated in the background. Saving your changes may create a conflict or cause loss of data.": "build configuration已在后台更新.保存修改可能导致冲突或丢失数据.",
"This build configuration has changed since you started editing it. You'll need to copy any changes you've made and edit again.": "build configuration已被修改,若编辑，你需要复制你的修改并且再编辑.",
"This build has been deleted.": "build已被删除.",
"This can be a time-consuming process.": "这可能是一个耗时较久的过程。",
"This config map has been deleted.": "config map已被删除.",
"This deployment can not be found, it may have been deleted.": "无法找到此deployment，它可能已被删除。",
"This deployment config is part of the pipeline": "此deployment configuration是pipeline的一部分",
"This deployment configuration can not be found, it may have been deleted.": "无法找到此deployment configuration，它可能已被删除。",
"This deployment configuration has been deleted.": "deployment configuration已被删除.",
"This deployment configuration has changed since you started editing it. You'll need to copy any changes you've made and edit again.": "deployment configuration已修改，若要编辑，你需要复制之前的修改然后再次编辑.",
"This deployment has been deleted.": "deployment已被删除.",
"This file contains binary content.": "该文件包含二进制内容。",
"This image declares volumes and will default to use non-persistent, host-local storage.You can add persistent storage later to the deployment config.": "此映像声明卷并将默认使用非持久性主机本地存储。您可以稍后在deployment config中添加持久存储。",
"This image stream has been deleted.": "image stream已被删除.",
"This image will be deployed in Deployment Config": "此镜像将部署在Deployment Config中",
...
"This pauses any in-progress rollouts and stops new rollouts from running until the deployment is resumed.": "这将暂停所有正在进行的rollouts，并停止运行新的rollouts，直到deployment恢复为止。",
...
"This resource has an autoscaler associated with it.It is recommended you delete the autoscaler with the resource it scales.": "此资源具有与之关联的autoscaler。建议您使用扩展的资源删除autoscaler。",
...
"This temporary pod has a modified entrypoint command to debug a failing container. The pod will be available for one hour and will be deleted when the terminal window is closed.": "此临时pod具有修改的入口点命令以调试失败的容器。 该pod将在一小时后可用，并在终端窗口关闭时删除。",
...
"This will delete the deployment config, all rollout history, and any running pods.": "这将删除deployment config，所有rollout历史记录和任何正在运行的pod。",
"This will delete the deployment, all rollout history, and any running pods.": "这将删除deployment，所有rollout历史记录和任何正在运行的pods。",
"This will overwrite the current version of the template.": "这将覆盖当前版本的模板。",
"This will prevent a value from being generated.": "这将阻止生成一个值。",
...
Time: "时间",
"Time Range:": "时间范围：",
"Time to wait between polling deployment status after running a pod.": "运行pod后polling deployment状态之间的等待时间。",
...
unknown: "未知",
Unknown: "未知",
"Unknown deployment strategy type:": "未知的deployment策略类型：",
"Update Period": "更新时间",
...
"Volume names may only contain lower-case letters, numbers, and dashes.They may not start or end with a dash.": "卷名称只能包含小写字母，数字和短划线。它们可能无法以破折号开始或结束。",
Volumes: "卷",
...
Warning: "警告",
"Warning:": "警告",
"Warning: The deployment's deployment config is missing.": "警告：缺少deployment的deployment config。",
warnings: "警告",
Warnings: "警告",
"was cancelled": "已取消",
"was cancelled.": "已取消",
...
Weight: "权重",
"Weight is a number between 0 and 256 that specifies the relative weight against other route services.": "权重是0到256之间的数字，用于指定与其他路线服务相对的权重。",
...
"When you navigate away from this pod, any open terminal connections will be closed.This will kill any foreground processes you started from the&nbsp;terminal.": "当您离开此pod时，将关闭所有打开的终端连接。这将终止您从终端开始的所有前台进程。",
...
"With the OpenShift command line interface (CLI), you can create applications and manage OpenShift projects from a terminal.": "使用OpenShift命令行接口（CLI），您可以从终端创建应用程序并管理OpenShift项目。",
"With the OpenShift command line interface (CLI), you can create applications and manage OpenShift projects from a terminal. To get started using the CLI, visit": "使用OpenShift命令行界面（CLI），您可以创建应用程序并管理OpenShift来自终端的项目。 要开始使用CLI，请访问",
...
"You must have a bindable service in your namespace in order to create bindings.": "您必须在命名空间中具有可绑定服务才能创建bindings。",
"You must select at least one container.": "您必须至少选择一个容器。",
"You should configure resource limits below for autoscaling.Autoscaling will not work without a CPU request.": "您应该在下面配置资源限制以进行自动扩容。 没有CPU要求，自动扩容将无法工作。",
"You will be logged out in": "您将退出在",
"You will need to redeploy your pods for this to take effect.": "您需要重新部署pod才能使其生效。",
"Your session is about to expire due to inactivity.": "由于长时间无活动，您的会话即将过期。"
});
} ]), angular.module("gettext").run([ "gettextCatalog", function(e) {
e.setStrings("zh_CN", {
...
"Application name must be at least 2 characters.": "应用名称至少两个字符。",
Back: "返回",
Binding: "绑定",
"Browse Catalog": "浏览Catalog",
...
Help: "帮助",
"Home Page Tour": "首页",
"If this is unexpected, click Cancel. This could be an attempt to trick you into acting as another user.": "如果不符合您的预期，请点击取消。这可能是来自其它用户的一次欺骗攻击。",
...
"Next >": "下一步>",
"No catalog items have been loaded.": "未加载到catalog项。",
...
"Return to the": "返回到",
Retype: "重新输入",
"Runtimes & Frameworks": "运行时 & 框架",
"Sample Repository:": "Sample仓库",
"Search Catalog": "搜索Catalog",
"See Loading the Default Image Streams and Templates": "查看加载默认的Image Streams和Templates",
"Select a Plan": "选择一个Plan",
"Select from Project": "从项目中选择",
"Select or create project": "选择或者创建项目",
"Select project": "选择项目",
"Service Dashboard": "Service控制面板",
"Services cannot be provisioned without a project.": "没有项目，Services不能分配。",
Show: "显示",
Success: "成功",
Support: "支持",
"Switch Users": "切换用户",
"Take Home Page Tour": "首页",
...
"The complete list of your projects could not be loaded. Type a project name to go to that project.": "无法加载完整的项目列表。请输入项目名并前往。",
"There are no plans currently available for this service.": "当前没有可供该服务选择的plan。",
...
"Toggle navigation": "切换导航",
"Try Sample Repository": "尝试Sample仓库",
"Unable to load all content for the catalog. Error loading": "无法从该catalog加载所有内容。加载错误。",
Update: "更新",
Updating: "更新中",
...
"View All": "查看所有",
"View Documentation": "查看文档",
"View Membership": "查看成员关系",
"View the result for Keyword:": "按关键词查看结果：",
"Virtual Machines": "虚拟机",
Virtualization: "虚拟化",
...
var r = e.status.total || e.status, o = j[a], i = 0;
...
}, R = [ "cpu", "requests.cpu", "memory", "requests.memory", "limits.cpu", "limits.memory" ], A = function(e, t, n, a, r) {
...
e ? (w.height && w.width ? k() : u.warn(f.getString("Unable to calculate the bounding box for a character.  Terminal will not be able to resize.")), r(j, 0)) : I();
...
D(e);
var t = {};
t[e.metadata.name] = e, a.logOptions.container = n.container || e.spec.containers[0].name, a.containerTerminals = R(), A(e), l.fetchReferencedImageStreamImages(t, a.imagesByDockerReference, a.imageStreamImageRefByDockerReference, S), y.push(s.watchObject(a.podsVersion, n.pod, r, function(e, t) {
D(e, t), N(a.containerTerminals), A(e);
}));
}, function(t) {
...
var w = a("orderObjectsByDate"), P = [ "metadata.name" ], j = [], k = function() {
...
e && (a.roleBindings[e.metadata.name] = e, a.subjectKindsForUI = d.mapRolebindingsForUI(a.roleBindings, w)), k();
});
}, R = function(t, n) {
a.disableAddForm = !0, p.create(t, n, v, h).then(function() {
T(), j("success", P.update.subject.success({
roleName: t.metadata.name,
subjectName: n.name
}));
}, function(a) {
k(), T(), j("error", P.update.subject.error({
roleName: t.metadata.name,
subjectName: n.name
}), e("getErrorDetails")(a));
});
...
}), k.push(o.watch(w, r, function(a, r, o) {
...
var C = !1, w = t("annotation"), P = t("humanizeKind")(d), j = t("hasDeployment"), k = a.getPreferredVersion("builds"), I = a.getPreferredVersion("imagestreams"), T = a.getPreferredVersion("horizontalpodautoscalers"), R = a.getPreferredVersion("limitranges"), A = a.getPreferredVersion("pods"), N = a.getPreferredVersion("replicasets"), E = a.getPreferredVersion("replicationcontrollers"), D = a.getPreferredVersion("resourcequotas"), $ = a.getPreferredVersion("appliedclusterresourcequotas");
switch (d) {
case "ReplicaSet":
...
})), e.deploymentConfigName && E(), L.push(i.watch(A, u, function(t) {
var n = t.by("metadata.name");
...
switch (e.sources.images && !_.isEmpty(e.sourceImages) && (e.updatedBuildConfig.spec.source.images[0].paths = R(e.imageSourcePaths), e.updatedBuildConfig.spec.source.images[0].from = A(e.imageOptions.fromSource)), "None" === e.imageOptions.from.type ? delete S(e.updatedBuildConfig).from : S(e.updatedBuildConfig).from = A(e.imageOptions.from), "None" === e.imageOptions.to.type ? delete e.updatedBuildConfig.spec.output.to : e.updatedBuildConfig.spec.output.to = A(e.imageOptions.to), S(e.updatedBuildConfig).env = p.compactEntries(e.envVars), $(e.updatedBuildConfig.spec.source, _.head(e.secrets.picked.gitSecret), "sourceSecret"), $(S(e.updatedBuildConfig), _.head(e.secrets.picked.pullSecret), "pullSecret"), $(e.updatedBuildConfig.spec.output, _.head(e.secrets.picked.pushSecret), "pushSecret"), e.strategyType) {
case "Source":
case "Docker":
...
n.hasDeploymentTrigger ? t.push(A(a, n.triggerData.istag, n.triggerData.data, n.triggerData.automatic)) : _.find(e.updatedDeploymentConfig.spec.template.spec.containers, {
name: a
}).image = n.image;
...
}), _.has(e, "strategyData.customParams.environment") && (e.strategyData.customParams.environment = f.compactEntries(e.strategyData.customParams.environment)), e.updatedDeploymentConfig.spec.template.spec.imagePullSecrets = _.filter(e.secrets.pullSecrets, "name"), e.updatedDeploymentConfig.spec.strategy = e.strategyData, e.updatedDeploymentConfig.spec.triggers = N(), E(), l.update(S, e.updatedDeploymentConfig.metadata.name, e.updatedDeploymentConfig, e.context).then(function() {
m.addNotification({
type: "success",
...
name: "app",
value: ""
}, R = t("orderByDisplayName"), A = t("getErrorDetails"), N = {}, E = function() {
...
var a = [];
t > 0 && a.push(j()), e > 0 && a.push(P()), n.all(a).then(S);
} else w();
}
function S() {
var e, n;
N(), "Template" === g.resourceKind && g.templateOptions.process && !g.errorOccurred ? g.isDialog ? g.$emit("fileImportedFromYAMLOrJSON", {
...
c.hideNotification("from-file-error"), _.each(A, function(e) {
!e.id || "error" !== e.type && "warning" !== e.type || c.hideNotification(e.id);
});
}, E = function(e) {
N(), A = u.getSecurityAlerts(g.createResources, g.input.selectedProject.metadata.name);
var t = e.quotaAlerts || [];
A = A.concat(t), _.filter(A, {
type: "error"
}).length ? (_.each(A, function(e) {
e.id = _.uniqueId("from-file-alert-"), c.addNotification(e);
}), g.disableInputs = !1) : A.length ? (R(A), g.disableInputs = !1) : b();
}, D = function() {
...
N(), s.toProjectOverview(g.input.selectedProject.metadata.name);
};
var $ = e("displayName");
g.$on("importFileFromYAMLOrJSON", g.create), g.$on("$destroy", N);
} ]
};
...
var R = p.find(".project-picker"), A = [], N = function() {
...
_.size(v) <= 100 ? (y = e("orderByDisplayName")(v), A = _.map(y, function(e) {
return n(e, !1);
})) : A = [ n(v[t], !0) ], R.empty(), R.append(A), R.append($('<option data-divider="true"></option>')), R.append($('<option value="">View All Projects</option>')), R.selectpicker("refresh");
}
}, E = function() {
...
}), i.currentProject = v[i.currentProjectName], N());
...
A[o] ? A[o].load(r) : ((n = V(e)).data = r, e.chartDataColors && (n.color = {
...
var T, R = {}, A = {}, N = n("resources.limits.memory"), E = n("resources.limits.cpu"), D = 30, $ = !1;
...
P && n.compactCombineWith && (i = n.compactCombineWith, n.lastValue && (N[i].lastValue = (N[i].lastValue || 0) + n.lastValue)), C[i] ? (C[i].load(r), t.showAverage ? C[i].legend.hide() : C[i].legend.show()) : ((a = D(n)).data = r, C[i] = c3.generate(a));
}));
}
function m() {
...
formatUsage: function(e) {
return A(e) && (e /= 1024), s.formatUsage(e);
},
...
T = {}, k = null, delete t.metricsError, b();
...
}, N = document.createDocumentFragment(), E = _.debounce(function() {
t.appendChild(N), N = document.createDocumentFragment(), e.autoScrollActive && A(), e.showScrollLinks || b();
}, 100, {
maxWait: 300
}), D = function(e) {
var n = r.defer();
...
n.resolve();
}), R.stop()) : n.resolve(), e || (E.cancel(), t && (t.innerHTML = ""), N = document.createDocumentFragment()), n.promise;
}, B = function() {
D().then(function() {
e.$evalAsync(function() {
if (e.run) {
...
var t = a + e;
r(e) ? (a = "", n++, N.appendChild(h(n, t)), E()) : a = t;
}, s = function(e) {
var t = o(e);
_.each(t, i);
};
...
e.autoScrollActive = !e.autoScrollActive, e.autoScrollActive && A();
},
...
var R, A = e("displayName"), N = function() {
var e = {
started: f.getString("Deploying image {{name}} to project {{project}}", {
name: n.app.name,
project: A(n.input.selectedProject)
}),
...
})) : S.length ? (E(S), n.disableInputs = !1) : N();
};
n.create = function() {
...
a.$evalAsync(function() {
v.notificationGroups = [ k(r.project, B($(b, S))) ], T();
});
}, V = function() {
_.each(y, function(e) {
e();
...
}), N(), L(), a.$emit("NotificationDrawerWrapper.onMarkAllRead");
},
notificationGroups: [],
...
u.markRead(e.uid), u.markCleared(e.uid), n.notifications.splice(t, 1), A(e), L();
},
markRead: function(e) {
