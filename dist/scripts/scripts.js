...
link: function(e, t) {
var n = $(".qr-code-container", t), r = function(e, t) {
e.qrcode({
text: t,
size: 250
});
};
r(n, e.content), e.$watch("content", function() {
n.find("canvas").remove(), r(n, e.content);
});
}
};
...
controller: [ "$timeout", "$anchorScroll", "$location", "APIService", "DataService", function(e, t, n, r, a) {
var o, i = this, s = r.getPreferredVersion("buildconfigs"), c = [];
i.$onChanges = function(e) {
var t = _.get(e, "mobileClient.currentValue", !1);
t && !i.context && (i.context = {
namespace: _.get(i, "mobileClient.metadata.namespace")
}), t && !i.buildsWatchSet && (i.buildsWatchSet = !0, c.push(a.watch(s, i.context, function(e) {
i.mobileBuildConfigs = _.filter(e.by("metadata.name"), function(e) {
return "true" === _.get(e, "metadata.labels.mobile-client-build") && _.get(e, "metadata.labels.mobile-client-id") === _.get(i, "mobileClient.metadata.name");
}), i.loaded = !0, i.goToBuildConfig();
})));
}, i.goToBuildConfig = function() {
n.hash() && o !== n.hash() && (o = n.hash(), e(function() {
t.yOffset = 100, t();
}, 400));
}, i.goToCreateClientBuild = function() {
n.url("project/" + i.mobileClient.metadata.namespace + "/create-client-build/" + i.mobileClient.metadata.name);
}, i.$onDestroy = function() {
a.unwatchAll(c);
};
} ],
...
controller: [ "$location", "APIService", "BuildsService", "DataService", "ListRowUtils", "Navigate", function(e, t, n, r, a, o) {
var i = this;
i.state = {}, i.buildConfigsInstantiateVersion = t.getPreferredVersion("buildconfigs/instantiate"), i.buildConfigsVersion = t.getPreferredVersion("buildconfigs");
var s, c = t.getPreferredVersion("builds"), l = [];
_.extend(i, a.ui), i.$onChanges = function(e) {
var t = _.get(e, "apiObject.currentValue", !1);
t && !i.context && (i.context = {
namespace: _.get(i, "apiObject.metadata.namespace")
}), t && i.context && !i.watchSet && (i.watchSet = !0, l.push(r.watch(c, i.context, function(e) {
var t = _.filter(e.by("metadata.name"), function(e) {
return _.get(e, "metadata.labels.buildconfig") === _.get(i, "apiObject.metadata.name");
}), r = n.sortBuilds(t, !0);
i.latestBuild = _.head(r), i.historyBuilds = _.tail(r), i.toggleExpandForAnchor();
})));
}, i.isMatchingAnchor = function() {
var t = _.get(i, "apiObject.metadata.name");
return e.hash() && e.hash() !== s && t === e.hash();
}, i.toggleExpandForAnchor = function() {
if (i.isMatchingAnchor()) {
s = e.hash(), i.expanded = "true";
var t = "overview/expand/" + _.get(i, "apiObject.metadata.uid");
sessionStorage.setItem(t, i.expanded);
}
}, i.startBuild = function() {
n.startBuild(i.apiObject);
}, i.deleteBuildConfig = function() {
n.deleteBuild(i.apiObject);
}, i.navigateToBuildConfig = function() {
var e = _.get(i, "apiObject.metadata.name"), t = _.get(i, "apiObject.kind"), n = _.get(i, "apiObject.metadata.namespace");
return o.resourceURL(e, t, n);
}, i.toggleBuildHistory = function() {
i.historyExpanded = !i.historyExpanded;
}, i.toggleLatestDownloadUrl = function() {
i.latestDownloadPanelExpanded = !i.latestDownloadPanelExpanded;
}, i.$onDestroy = function() {
r.unwatchAll(l);
};
} ],
...
var r = this, a = e("annotationName"), o = a("mobileGetBuildDownload"), i = a("mobileSetBuildDownload"), s = t.getPreferredVersion("builds");
r.$onChanges = function(e) {
var t = e.mobileBuild && e.mobileBuild.currentValue, n = {
namespace: _.get(r, "mobileBuild.metadata.namespace")
};
if (t) {
var a = _.get(r, "mobileBuild.metadata.annotations", {});
r.url = a[o];
}
e.showPanel && e.showPanel.currentValue && (r.mobileBuild.metadata.annotations[o] || r.requestBuildDownloadUrl(n));
}, r.requestBuildDownloadUrl = function(e) {
var t = angular.copy(r.mobileBuild);
t.metadata.annotations[i] = "true", n.update(s, t.metadata.name, t, e);
};
} ],
bindings: {
mobileBuild: "<",
