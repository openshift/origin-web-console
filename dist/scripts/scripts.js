...
"This image declares volumes and will default to use non-persistent, host-local storage.You can add persistent storage later to the deployment config.": "此映像声明卷并将默认使用非持久性主机本地存储。您可以稍后在部署配置中添加持久存储。",
