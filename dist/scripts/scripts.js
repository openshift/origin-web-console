...
link:function(d) {
function e() {
return a(p + "://" + q + "/v1/namespaces/:namespace/services", {
namespace:n
}, {
get:{
headers:{
...
e().get(function(a) {
var b = [];
d.inOpenShift = a, a.items.forEach(function(a) {
...
var o = {}, p = "http:" === l.location.protocol ? "http" :"https", q = l.OPENSHIFT_CONFIG.api.k8s.hostPort + l.OPENSHIFT_CONFIG.api.k8s.prefix, r = "Bearer", s = r + " " + localStorage.getItem("LocalStorageUserStore.token"), t = [];
f();
...
var a = m.findServiceV1(o), b = m.findDeploymentConfigV1(o), c = m.findServiceV2(o), e = m.findDeploymentConfigV2(o);
t = [ a, b, c, e ], w();
};
}
};
...
function k(a) {
angular.forEach(a, function(a) {
"K8S_NAMESPACE" !== a.name && (o.appParams[a.name] = a);
});
}
function l(a) {
angular.forEach(a, function(a) {
"K8S_NAMESPACE" === a.name && (a.value = o.selectedProject.metadata.name);
});
}
var m, n, o = this, p = a("displayName"), q = a("humanize");
o.appParams = {}, o.$onInit = function() {
o.labels = [], o.template = i.squidTemplate(), o.templateDisplayName = p(o.template), o.selectedProject = o.project, k(o.template.parameters);
};
var r = function() {
var a = {
...
j.clear(), j.add(a, o.template, o.selectedProject.metadata.name, function() {
var a = b.defer();
return e.batch(n, m).then(function(b) {
var c = [], d = !1;
b.failure.length > 0 ? (d = !0, b.failure.forEach(function(a) {
c.push({
type:"error",
...
g.hideNotification("process-template-error"), _.each(s, function(a) {
!a.id || "error" !== a.type && "warning" !== a.type || g.hideNotification(a.id);
});
}, u = function() {
t(), r();
};
o.createFromSquid = function() {
l(o.template.parameters), m = {
namespace:o.selectedProject.metadata.name
}, e.create("processedtemplates", null, o.template, m).then(function(a) {
h.setTemplateData(a.parameters, o.template.parameters, a.message), n = a.objects, u();
}, function(a) {
o.disableInputs = !1;
var b;
a.data && a.data.message && (b = a.data.message), g.addNotification({
...
t(), f.toProjectOverview(o.project.metadata.name);
};
}
