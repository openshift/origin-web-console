...
var B = t("annotation"), L = t("canI"), V = t("buildConfigForBuild"), O = t("deploymentIsInProgress"), U = t("imageObjectRef"), F = t("isJenkinsPipelineStrategy"), x = t("isNewerResource"), M = t("label"), q = t("podTemplate"), z = i.getPreferredVersion("buildconfigs"), H = i.getPreferredVersion("builds"), G = i.getPreferredVersion("deploymentconfigs"), K = i.getPreferredVersion("deployments"), W = i.getPreferredVersion("horizontalpodautoscalers"), Q = i.getPreferredVersion("replicasets"), J = i.getPreferredVersion("routes"), Y = i.getPreferredVersion("servicebindings"), Z = i.getPreferredVersion("clusterserviceclasses"), X = i.getPreferredVersion("serviceinstances"), ee = i.getPreferredVersion("clusterserviceplans"), te = i.getPreferredVersion("statefulsets");
N.buildConfigsInstantiateVersion = i.getPreferredVersion("buildconfigs/instantiate");
var ne, re, ae = {}, oe = {}, ie = {}, se = N.state = {
alerts: {},
builds: {},
clusterQuotas: {},
...
$(window).on("resize.overview", ce), N.showGetStarted = !1, N.showLoading = !0, N.filterByOptions = [ {
id: "name",
label: "Name"
}, {
id: "label",
...
se.expandAll = t && 1 === N.size, N.showGetStarted = t && e, N.showLoading = !t && e, N.everythingFiltered = !e && !N.filteredSize, N.hidePipelineOtherResources = "pipeline" === N.viewBy && (N.filterActive || _.isEmpty(N.pipelineBuildConfigs));
}, fe = function(e) {
...
N.filteredDeploymentConfigsByApp = fe(N.filteredDeploymentConfigs), N.filteredReplicationControllersByApp = fe(N.filteredReplicationControllers), N.filteredDeploymentsByApp = fe(N.filteredDeployments), N.filteredReplicaSetsByApp = fe(N.filteredReplicaSets), N.filteredStatefulSetsByApp = fe(N.filteredStatefulSets), N.filteredMonopodsByApp = fe(N.filteredMonopods), N.apps = _.union(_.keys(N.filteredDeploymentConfigsByApp), _.keys(N.filteredReplicationControllersByApp), _.keys(N.filteredDeploymentsByApp), _.keys(N.filteredReplicaSetsByApp), _.keys(N.filteredStatefulSetsByApp), _.keys(N.filteredMonopodsByApp)), s.sortAppNames(N.apps), ve();
}, ye = function() {
...
}, Ce = [ "metadata.name", "spec.clusterServiceClassExternalName" ], _e = function(e) {
return y.filterForKeywords(e, Ce, se.filterKeywords);
}, we = function(e) {
switch (N.filterBy) {
case "label":
return Se(e);
...
N.filteredDeploymentConfigs = we(N.deploymentConfigs), N.filteredReplicationControllers = we(N.vanillaReplicationControllers), N.filteredDeployments = we(N.deployments), N.filteredReplicaSets = we(N.vanillaReplicaSets), N.filteredStatefulSets = we(N.statefulSets), N.filteredMonopods = we(N.monopods), N.filteredPipelineBuildConfigs = we(N.pipelineBuildConfigs), N.filteredServiceInstances = we(se.orderedServiceInstances), N.filterActive = Pe(), he(), pe();
}, ke = a.project + "/overview/view-by";
N.viewBy = localStorage.getItem(ke) || "app", e.$watch(function() {
return N.viewBy;
}, function(e) {
localStorage.setItem(ke, e), be(), Ce = "app" === N.viewBy ? [ "metadata.name", "metadata.labels.app" ] : [ "metadata.name" ], je(), "pipeline" === N.viewBy ? b.setLabelSuggestions(oe) : b.setLabelSuggestions(ae);
...
var t = ue(e);
return t ? Ie(e) ? [ e ] : _.get(N, [ "state", "podsByOwnerUID", t ], []) : [];
}, Ee = function(e, t) {
var n = ue(e);
...
if (ue(e)) {
var t = Re(e), n = R.getPodAlerts(t, a.project);
Ee(e, n);
}
}, De = function(e) {
_.each(e, Ne);
...
_.each(N.deploymentConfigs, Be);
}, Ve = function(e) {
var t = ue(e);
return t ? _.get(N, [ "replicaSetsByDeploymentUID", t ]) : {};
}, Oe = function(e) {
var t = R.getPausedDeploymentAlerts(e), n = Ve(e);
_.each(n, function(e) {
var n = Te(e);
_.assign(t, n);
}), Ee(e, t);
}, Ue = function() {
_.each(N.deployments, Oe);
}, Fe = function() {
De(N.replicationControllers), De(N.replicaSets), De(N.statefulSets), De(N.monopods);
}, xe = _.debounce(function() {
e.$evalAsync(function() {
Fe(), Le(), Ue();
});
}, 500), Me = function(e) {
_.isEmpty(e) || (b.addLabelSuggestionsFromResources(e, ae), "pipeline" !== N.viewBy && b.setLabelSuggestions(ae));
}, qe = function(e) {
_.isEmpty(e) || (b.addLabelSuggestionsFromResources(e, oe), "pipeline" === N.viewBy && b.setLabelSuggestions(oe));
}, ze = function(e) {
...
se.podsByOwnerUID = j.groupByOwnerUID(N.pods), N.monopods = _.filter(se.podsByOwnerUID[""], ze);
}, Ge = function(e) {
...
var e = [];
N.replicationControllersByDeploymentConfig = {}, N.currentByDeploymentConfig = {}, ie = {};
var t = {}, n = {};
...
o && !x(r, o) || (ie[a] = r);
var i;
"Complete" === B(r, "deploymentStatus") && ((i = t[a]) && !x(r, i) || (t[a] = r)), Ge(r) && _.set(n, [ a, r.metadata.name ], r);
...
}), N.vanillaReplicationControllers = _.sortBy(e, "metadata.name"), Le();
}
}, Qe = function(e, t) {
...
N.replicaSets && ne && (N.replicaSetsByDeploymentUID = P.groupByControllerUID(N.replicaSets), N.currentByDeploymentUID = {}, _.each(N.replicaSetsByDeploymentUID, function(e, t) {
if (t) {
var n = ne[t], r = _.filter(e, function(e) {
return Qe(e, n);
}), a = p.sortByRevision(r);
N.replicaSetsByDeploymentUID[t] = a, N.currentByDeploymentUID[t] = _.head(a);
}
}), N.vanillaReplicaSets = _.sortBy(N.replicaSetsByDeploymentUID[""], "metadata.name"), Ue());
}, Ye = {}, Ze = function(e) {
e && se.allServices && _.each(e, function(e) {
var t = [], n = ue(e), r = q(e);
_.each(Ye, function(e, n) {
e.matches(r) && t.push(se.allServices[n]);
}), se.servicesByObjectUID[n] = _.sortBy(t, "metadata.name");
});
}, Xe = function() {
if (se.allServices) {
Ye = _.mapValues(se.allServices, function(e) {
...
se.routesByService = _.mapValues(e, E.sortRoutesByScore), ve();
}, tt = function() {
se.hpaByResource = g.groupHPAs(N.horizontalPodAutoscalers);
}, nt = function(e) {
...
rt = l.groupBuildConfigsByOutputImage(N.buildConfigs);
}, ot = function(e) {
var t = ue(e);
...
var e = [];
N.deploymentConfigsByPipeline = {}, se.pipelinesByDeploymentConfig = {}, _.each(N.buildConfigs, function(t) {
if (F(t)) {
e.push(t);
var n = l.usesDeploymentConfigs(t), r = le(t);
...
}), N.pipelineBuildConfigs = _.sortBy(e, "metadata.name"), ye(), qe(N.pipelineBuildConfigs), be();
}, lt = function() {
se.buildConfigsByObjectUID = {}, _.each(N.deploymentConfigs, function(e) {
var t = [], n = _.get(e, "spec.triggers");
_.each(n, function(n) {
var r = _.get(n, "imageChangeParams.from");
if (r) {
var a = U(r, e.metadata.namespace), o = rt[a];
_.isEmpty(o) || (t = t.concat(o));
}
}), t = _.sortBy(t, "metadata.name"), st(t, e), it(e);
});
}, ut = function() {
ct(), lt();
}, dt = function() {
_.each(N.deploymentConfigs, it);
}, mt = function() {
if (se.builds && N.buildConfigs) {
N.recentPipelinesByBuildConfig = {}, se.recentBuildsByBuildConfig = {}, se.recentPipelinesByDeploymentConfig = {};
var e = {};
_.each(l.interestingBuilds(se.builds), function(t) {
var n = V(t);
F(t) ? nt(t) : (e[n] = e[n] || [], e[n].push(t));
...
t !== n && (se.filterKeywords = y.generateKeywords(t), e.$evalAsync(je));
}, 50, {
maxWait: 250
})), e.$watch(function() {
return N.filterBy;
}, function(e, t) {
e !== t && (N.clearFilter(), je());
...
_.each(e, function(e) {
_.each(e, function(e) {
var n = ue(e), r = new LabelSelector(_.get(e, "spec.selector"));
...
k.get(a.project, ht).then(_.spread(function(t, r) {
se.project = e.project = t, se.context = r;
var a = function() {
N.pods && h.fetchReferencedImageStreamImages(N.pods, se.imagesByDockerReference, se.imageStreamImageRefByDockerReference, r);
};
vt.push(m.watch("pods", r, function(e) {
N.pods = e.by("metadata.name"), He(), a(), xe(), Ze(N.monopods), De(N.monopods), Me(N.monopods), je(), S.log("pods (subscribe)", N.pods);
})), vt.push(m.watch("replicationcontrollers", r, function(e) {
N.replicationControllers = e.by("metadata.name"), We(), Ze(N.vanillaReplicationControllers), Ze(N.monopods), De(N.vanillaReplicationControllers), Me(N.vanillaReplicationControllers), ft(), je(), S.log("replicationcontrollers (subscribe)", N.replicationControllers);
})), vt.push(m.watch(G, r, function(e) {
N.deploymentConfigs = e.by("metadata.name"), We(), Ze(N.deploymentConfigs), Ze(N.vanillaReplicationControllers), Me(N.deploymentConfigs), Ue(), ut(), dt(), ft(), je(), S.log("deploymentconfigs (subscribe)", N.deploymentConfigs);
})), vt.push(m.watch(Q, r, function(e) {
N.replicaSets = e.by("metadata.name"), Je(), Ze(N.vanillaReplicaSets), Ze(N.monopods), De(N.vanillaReplicaSets), Me(N.vanillaReplicaSets), ft(), je(), S.log("replicasets (subscribe)", N.replicaSets);
})), vt.push(m.watch(K, r, function(e) {
ne = e.by("metadata.uid"), N.deployments = _.sortBy(ne, "metadata.name"), Je(), Ze(N.deployments), Ze(N.vanillaReplicaSets), Me(N.deployments), ft(), je(), S.log("deployments (subscribe)", N.deploymentsByUID);
})), vt.push(m.watch(H, r, function(e) {
se.builds = e.by("metadata.name"), mt(), S.log("builds (subscribe)", se.builds);
})), vt.push(m.watch(te, r, function(e) {
N.statefulSets = e.by("metadata.name"), Ze(N.statefulSets), Ze(N.monopods), De(N.statefulSets), Me(N.statefulSets), ft(), je(), S.log("statefulsets (subscribe)", N.statefulSets);
}, {
poll: D,
pollInterval: 6e4
})), vt.push(m.watch("services", r, function(e) {
se.allServices = e.by("metadata.name"), Xe(), S.log("services (subscribe)", se.allServices);
}, {
poll: D,
pollInterval: 6e4
})), vt.push(m.watch(J, r, function(e) {
N.routes = e.by("metadata.name"), et(), S.log("routes (subscribe)", N.routes);
}, {
poll: D,
pollInterval: 6e4
})), vt.push(m.watch(z, r, function(e) {
N.buildConfigs = e.by("metadata.name"), at(), ut(), mt(), je(), S.log("buildconfigs (subscribe)", N.buildConfigs);
}, {
poll: D,
pollInterval: 6e4
})), vt.push(m.watch(W, r, function(e) {
N.horizontalPodAutoscalers = e.by("metadata.name"), tt(), S.log("autoscalers (subscribe)", N.horizontalPodAutoscalers);
}, {
poll: D,
pollInterval: 6e4
})), vt.push(m.watch("imagestreams", r, function(e) {
re = e.by("metadata.name"), h.buildDockerRefMapForImageStreams(re, se.imageStreamImageRefByDockerReference), a(), S.log("imagestreams (subscribe)", re);
}, {
poll: D,
pollInterval: 6e4
})), vt.push(m.watch("resourcequotas", r, function(e) {
se.quotas = e.by("metadata.name"), pt();
}, {
poll: !0,
pollInterval: 6e4
})), vt.push(m.watch("appliedclusterresourcequotas", r, function(e) {
se.clusterQuotas = e.by("metadata.name"), pt();
}, {
poll: !0,
pollInterval: 6e4
}));
var o, i, s = {}, c = {};
u.SERVICE_CATALOG_ENABLED && L(X, "watch") && (o = function(e) {
var t = T.getServiceClassNameForInstance(e);
if (!t) return n.when();
var r = _.get(se, [ "serviceClasses", t ]);
return r ? n.when(r) : (s[t] || (s[t] = m.get(Z, t, {}).then(function(e) {
...
return r ? n.when(r) : (c[t] || (c[t] = m.get(ee, t, {}).then(function(e) {
return se.servicePlans[t] = e, e;
}).finally(function() {
delete c[t];
})), c[t]);
}, vt.push(m.watch(X, r, function(e) {
se.serviceInstances = e.by("metadata.name");
var t = [];
_.each(se.serviceInstances, function(e) {
var n = R.getServiceInstanceAlerts(e);
Ee(e, n), t.push(o(e)), t.push(i(e));
}), I.waitForAll(t).finally(function() {
gt(), je();
}), Me(se.serviceInstances);
}, {
poll: D,
pollInterval: 6e4
}))), u.SERVICE_CATALOG_ENABLED && L(Y, "watch") && vt.push(m.watch(Y, r, function(e) {
se.bindings = e.by("metadata.name"), N.bindingsByInstanceRef = _.groupBy(se.bindings, "spec.instanceRef.name"), ft();
}, {
poll: D,
pollInterval: 6e4
...
m.unwatchAll(vt), $(window).off(".overview");
});
}), function(t) {
...
if (!e) return null;
var t = n.objectToResourceGroupVersion(e);
return t.resource = t.resource + "/scale", t;
}, i.prototype.scale = function(e, t) {
var a, o = this.getScaleResource(e), i = {
apiVersion: a = "DeploymentConfig" !== e.kind || "v1" !== e.apiVersion && "apps.openshift.io/v1" !== e.apiVersion ? n.toAPIVersion(o) : "extensions/v1beta1",
kind: "Scale",
metadata: {
name: e.metadata.name,
namespace: e.metadata.namespace,
...
return r.update(o, e.metadata.name, i, {
namespace: e.metadata.namespace
});
};
var m = function(e, t) {
...
if ("HorizontalPodAutoscaler" === n.kind) e.targetKind = _.get(a, "spec.scaleTargetRef.kind"), e.targetName = _.get(a, "spec.scaleTargetRef.name"), _.assign(e.autoscaling, {
