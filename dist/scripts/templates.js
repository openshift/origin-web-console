angular.module('openshiftConsoleTemplates', []).run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('views/overview/_service-binding.html',
    ...
    "</delete-link>\n" +
    "<a ng-if=\"('secrets' | canI : 'get')\" ng-href=\"{{$ctrl.binding.spec.secretName | navigateResourceURL : 'Secret' : $ctrl.namespace}}\" translate>\n" +
    "View Secret\n" +
    "</a>\n" +
    "</div>\n" +
    "</div>"
  ...
  $templateCache.put('views/projects.html',
    ...
    "</button>\n" +
    "<origin-modal-popup shown=\"newProjectPanelShown\" modal-title=\"{{'Create Project'|translate}}\" on-close=\"closeNewProjectPanel\">\n" +
