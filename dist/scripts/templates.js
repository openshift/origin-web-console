angular.module('openshiftConsoleTemplates', []).run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('views/modals/set-home-page-modal.html',
    ...
    "</p>\n" +
    "<ng-form name=\"homePageForm\">\n" +
    "<fieldset ng-disabled=\"loading\">\n" +
    "<div class=\"radio\">\n" +
    "<label>\n" +
    "<input type=\"radio\" ng-model=\"preferredHomePage\" value=\"catalog-home\">\n" +
    "Catalog Home (Default)\n" +
    "</label>\n" +
    "</div>\n" +
    "<div class=\"radio\">\n" +
    "<label>\n" +
    "<input type=\"radio\" ng-model=\"preferredHomePage\" value=\"project-list\">\n" +
    "My Projects List\n" +
    "</label>\n" +
    "</div>\n" +
    "<div class=\"radio\" ng-show=\"availableProjects.length >= 1\">\n" +
    "<label>\n" +
    "<input type=\"radio\" ng-model=\"preferredHomePage\" value=\"project-overview\">\n" +
    "Overview Page for {{availableProjects.length === 1 ? (selectedProject | displayName) : ':'}}\n" +
    "</label>\n" +
    "<div class=\"select-project-container\">\n" +
    "<select-project ng-if=\"availableProjects.length > 1\" class=\"select-project\" on-project-selected=\"onProjectSelected\" on-open=\"onOpen\" available-projects=\"availableProjects\" selected-project=\"selectedProject\" hide-create-project=\"true\" hide-label=\"true\">\n" +
    "</select-project>\n" +
    "</div>\n" +
    "</div>\n" +
    "</fieldset>\n" +
    ...
    "</div>\n" +
    "<div class=\"modal-footer\">\n" +
    "<button class=\"btn btn-lg btn-primary\" type=\"button\" ng-disabled=\"(preferredHomePage === 'project-overview' && homePageForm.$invalid) || homePageForm.$pristine\" ng-click=\"setHomePage()\">Save</button>\n" +
    "<button class=\"btn btn-lg btn-default\" type=\"button\" ng-click=\"cancel()\">Cancel</button>\n" +
    "</div>\n" +
    "</div>"
  );
