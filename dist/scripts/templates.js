angular.module('openshiftConsoleTemplates', []).run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('views/browse/build-config.html',
    ...
    "<key-value-editor entries=\"envVars\" key-placeholder=\"Name\" value-placeholder=\"Value\" value-from-selector-options=\"valueFromObjects\" ey-validator=\"[-._a-zA-Z][-._a-zA-Z0-9]*\" key-validator-error=\"Please enter a valid key.\" key-validator-error-tooltip=\"A valid environment variable name must consist of alphabetic characters, digits, '_', '-', or '.', and must not start with a digit.\" add-row-link=\"Add Value\" add-row-with-selectors-link=\"Add Value from Config Map or Secret\" show-header></key-value-editor>\n" +
  ...
  $templateCache.put('views/create/fromimage.html',
    ...
    "</div>\n" +
    "<key-value-editor entries=\"DCEnvVarsFromUser\" key-placeholder=\"name\" value-placeholder=\"value\" value-from-selector-options=\"valueFromObjects\" key-validator=\"[-._a-zA-Z][-._a-zA-Z0-9]*\" kkey-validator-error-tooltip=\"A valid environment variable name must consist of alphabetic characters, digits, '_', '-', or '.', and must not start with a digit.\" add-row-link=\"Add Value\" add-row-with-selectors-link=\"Add Value from Config Map or Secret\"></key-value-editor>\n" +
    "</div>\n" +
    "</div>\n" +
    "</osc-form-section>\n" +
    "\n" +
