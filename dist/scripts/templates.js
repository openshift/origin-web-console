angular.module('openshiftConsoleTemplates', []).run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('views/overview/_service-group.html',
    ...
    "<i class=\"fa fa-angle-right fa-fw\" aria-hidden=\"true\" ng-if=\"collapse\"></i>\n" +
    "</span>\n" +
    "<a ng-if=\"displayRoute | isWebRoute\" target=\"_blank\" ng-href=\"{{displayRoute | routeWebURL}}\" ng-class=\"{ 'disabled-link': !(displayRoute.metadata.name | hasRouteEndpoints : endpoints)}\" link-disabled=\"!(displayRoute.metadata.name | hasRouteEndpoints : endpoints)\">{{displayRoute | routeLabel}}</a>\n" +
