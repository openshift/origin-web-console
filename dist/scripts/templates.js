angular.module('openshiftConsoleTemplates', []).run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('views/_build-trends-chart.html',
    ...
    "</svg>\n" +
    "<span style=\"vertical-align: top\"><translate>Average</translate>: {{averageDurationText}}</span>\n" +
    "</span>\n" +
    "</a>\n" +
    "</div>\n" +
    "</div>\n" +
  ...
  $templateCache.put('views/_compute-resource.html',
    ...
    "<translate>Can't be less than</translate> {{limitRangeMin | usageWithUnits : type}}.\n" +
    "</div>\n" +
    "<div ng-if=\"form.amount.$error.limitRangeMax\" class=\"help-block\">\n" +
    "<translate>Can't be greater than</translate> {{limitRangeMax | usageWithUnits : type}}.\n" +
    "</div>\n" +
    "<div ng-if=\"form.amount.$error.limitLargerThanRequest\" class=\"help-block\">\n" +
    "<translate>Limit can't be less than request</translate> ({{request | usageWithUnits : type}}).\n" +
    "</div>\n" +
    "<div ng-if=\"form.amount.$error.limitWithinRatio\" class=\"help-block\">\n" +
    "<span ng-if=\"!input.amount && !defaultValue\">\n" +
    "<translate>Limit is required if request is set.</translate> (Max Limit/Request Ratio:{{maxLimitRequestRatio}})\n" +
    "</span>\n" +
    "<span ng-if=\"input.amount || defaultValue\">\n" +
  ...
  $templateCache.put('views/_container-statuses.html',
    ...
    "<h4><translate>Init container</translate> {{containerStatus.name}}</h4>\n" +
    ...
    "<h4><translate>Container</translate> {{containerStatus.name}}</h4>\n" +
    "<dl class=\"dl-horizontal left\">\n" +
    "<dt translate>State:</dt>\n" +
    "<dd>\n" +
    "<kubernetes-object-describe-container-state container-state=\"containerStatus.state\"></kubernetes-object-describe-container-state>\n" +
  ...
  $templateCache.put('views/_edit-request-limit.html',
    ...
    "</small>\n" +
    "<small ng-if=\"limits.min && !limits.max\">\n" +
    "<translate>Min</translate>: {{limits.min | usageWithUnits : type}}\n" +
    "</small>\n" +
    "<small ng-if=\"limits.max && !limits.min\">\n" +
    "<translate>Max</translate>: {{limits.max | usageWithUnits : type}}\n" +
    "</small>\n" +
    "</h3>\n" +
    "\n" +
    ...
    "<span ng-if=\"type === 'cpu'\">millicores</span>\n" +
    "<span ng-if=\"type === 'memory'\">MiB</span>?</a>\n" +
    "</div>\n" +
    "</ng-form>"
  );
  ...
  $templateCache.put('views/_image-names.html',
    ...
    "</span>\n" +
    "<span class=\"nowrap\" ng-if=\"podTemplate.spec.containers.length > 1\"> <translate>and</translate> {{podTemplate.spec.containers.length - 1}} <translate>other images</translate></span>\n" +
    "</span>\n" +
    "</div>"
  );
  ...
  $templateCache.put('views/_pod-template.html',
    ...
    "<span ng-if=\"podTemplate.spec.containers.length === 1\"><translate>Container</translate> {{podTemplate.spec.containers[0].name}} <translate>does not have health checks</translate></span>\n" +
  ...
  $templateCache.put('views/_templateopt.html',
    ...
    "<div class=\"help-block\">{{parameter.displayName || parameter.name}} <translate>is required.</translate></div>\n" +
    "</div>\n" +
    ...
    "<div class=\"help-block\">{{parameter.name}} <translate>is required.</translate></div>\n" +
    "</div>\n" +
    "</li>\n" +
    "</ul>\n" +
    "</div>"
  ...
  $templateCache.put('views/_volume-claim-templates.html',
    ...
    "<div class=\"pod-container-name\"><translate>Storage claim</translate>: {{template.metadata.name}}</div>\n" +
  ...
  $templateCache.put('views/_webhook-trigger-cause.html',
    ...
    "<translate>authored by</translate> {{trigger.githubWebHook.revision.git.author.name || trigger.genericWebHook.revision.git.author.name}},\n" +
    "</span>\n" +
  ...
  $templateCache.put('views/add-config-volume.html',
    ...
    "<h2>{{kind | humanizeKind}} <translate>could not be loaded.</translate></h2>\n" +
    ...
    "<p>\n" +
    "<translate>There are no config maps or secrets in project</translate> {{project | displayName}} <translate>to use as a volume for this</translate> {{kind | humanizeKind}}.\n" +
    "</p>\n" +
    ...
    "<translate>Add values from a config map or secret as volume. This will make the data available as files for</translate> {{kind | humanizeKind}} {{name}}.\n" +
    "</div>\n" +
  ...
  $templateCache.put('views/attach-pvc.html',
    ...
    "<p>\n" +
    "<translate>A persistent volume claim is required to attach to this</translate> {{kind | humanizeKind}},\n" +
    ...
    "</p>\n" +
    "<p ng-if=\"attach.resource\"><a ng-href=\"{{attach.resource | navigateResourceURL}}\"><translate> Back to </translate> {{kind | humanizeKind}} {{name}}</a></p>\n" +
    "</div>\n" +
    "<div ng-show=\"pvcs && pvcs.length && attach.resource\" class=\"mar-top-xl\">\n" +
    "<h1 translate>Add Storage to {{name}}</h1>\n" +
    "<div class=\"help-block\">\n" +
    "<translate>Add an existing persistent volume claim to the template of </translate>{{kind | humanizeKind}} {{name}}.\n" +
    "</div>\n" +
    ...
    "<span class=\"help-block\">\n" +
    "<translate>Path must be a relative path. It cannot start with</translate> <code>/</code> <translate>or contain </translate>\n" +
    "<code>..</code> <translate>path elements.</translate>\n" +
    "</span>\n" +
    "</div>\n" +
    "</div>\n" +
    "<div class=\"form-group\">\n" +
  ...
  $templateCache.put('views/browse/_build-details.html',
    ...
    "</div>\n" +
    "</dl>\n" +
    "<h3><span translate>Configuration</span> <span class=\"small\" ng-if=\"buildConfigName\"><span translate>created from</span> <a href=\"{{build | configURLForResource}}\">{{buildConfigName}}</a></span></h3>\n" +
    "<dl class=\"dl-horizontal left\">\n" +
  ...
  $templateCache.put('views/browse/build-config.html',
    ...
    "<translate>View the</translate><a ng-href=\"{{(buildConfig | navigateResourceURL) + '?tab=configuration'}}\">Jenkinsfile</a> <translate>to see what stages will run.</translate>\n" +
    "</span>\n" +
  ...
  $templateCache.put('views/browse/persistent-volume-claim.html',
    ...
    "<translate>waiting for</translate> {{pvc.spec.resources.requests['storage'] | usageWithUnits: 'storage'}}<translate>allocation</translate>,\n" +
    "</span>\n" +
    ...
    "<translate>allocated</translate> {{pvc.status.capacity['storage'] | usageWithUnits: 'storage'}}\n" +
    "</span>\n" +
  ...
  $templateCache.put('views/browse/pod.html',
    ...
    "<span class=\"pficon pficon-info\" aria-hidden=\"true\"></span>\n" +
    "<translate>Environment variables were set by </translate>{{controllerRef.kind | humanizeKind}}\n" +
  ...
  $templateCache.put('views/browse/stateful-sets.html',
    ...
    "</div>\n" +
    "<div ng-if=\"filterWithZeroResults\">\n" +
    "<h2>The filter is hiding all stateful sets. <button type=\"button\" class=\"btn btn-link inline-btn-link\" ng-click=\"clearFilter()\" translate>Clear All Filters</button></h2>\n" +
    "</div>\n" +
    "</div>\n" +
    "</div>\n" +
  ...
  $templateCache.put('views/catalog/catalog.html',
    ...
    "<code>openshift</code> <translate>namespace. An image or template is required to add content.</translate>\n" +
    "</p>\n" +
    "<p>\n" +
    "<translate>To add an image stream or template from a file, use the editor in the</translate>\n" +
    "<strong translate>Import YAML / JSON</strong> <translate>tab, or run the following command:</translate>\n" +
  ...
  $templateCache.put('views/command-line.html',
    ...
    "<translate>You can download the oc client tool using the links below. For more information about downloading and installing it, please refer to the</translate> <a target=\"_blank\" href=\"{{'get_started_cli' | helpLink}}\" translate>Get Started with the CLI</a> <translate>documentation.</translate>\n" +
    "</span>\n" +
    "<span ng-if=\"!cliDownloadURLPresent\">\n" +
    "<translate>Refer to the</translate> <a target=\"_blank\" href=\"{{'get_started_cli' | helpLink}}\" translate>Get Started with the CLI</a> <translate>documentation for instructions about downloading and installing the oc client tool.</translate>\n" +
    "</span>\n" +
  ...
  $templateCache.put('views/create-from-url.html',
    ...
    "<p ng-if=\"validationPassed && createDetails.sourceURI\"> <a href=\"{{createDetails.sourceURI}}\">{{createDetails.sourceURI}}</a><translate>source code will be built and deployed unless otherwise specified in the next step.</translate></p>\n" +
  ...
  $templateCache.put('views/create/fromimage.html',
    ...
    "{{showDCEnvs ? 'Hide' : 'Show'}} <translate>Image Environment Variables</translate>\n" +
    "</a>\n" +
    "</p>\n" +
  ...
  $templateCache.put('views/directives/_edit-command.html',
    ...
    "<a href=\"\" ng-click=\"multiline = !multiline\"><translate>Switch to </translate>{{multiline ? 'Single-line' : 'Multiline'}} <translate>Editor</translate></a>\n" +
    "<span ng-show=\"input.args.length\">\n" +
    "<span class=\"action-divider\">|</span>\n" +
    "<a href=\"\" ng-click=\"clear()\" role=\"button\"><translate>Clear</translate> {{ (type || 'Command') | upperFirst }}</a>\n" +
    "</span>\n" +
    "</div>\n" +
    "\n" +
  ...
  $templateCache.put('views/directives/_probe.html',
    ...
    "<span ng-if=\"probe.initialDelaySeconds\" class=\"nowrap\">{{probe.initialDelaySeconds}}s <translate>delay,</translate></span>\n" +
    "<span class=\"nowrap\">{{probe.timeoutSeconds || 1}}s <translate>timeout</translate></span>\n" +
    "</small>"
  );
  ...
  $templateCache.put('views/directives/add-config-to-application.html',
    ...
    "<span class=\"help-block\">\n" +
    "{{ctrl.apiObject.kind | humanizeKind}} <translate>has already been added to this application.</translate>\n" +
    "</span>\n" +
    "</div>\n" +
    "<legend><translate>Add</translate> {{ctrl.apiObject.kind | humanizeKind}} <translate>as</translate>:</legend>\n" +
    "<div class=\"radio\">\n" +
    "<label for=\"env\">\n" +
    ...
    "{{ctrl.apiObject.kind | humanizeKind | upperFirst}} <strong>{{ctrl.apiObject.metadata.name}}</strong> <translate>contains keys that are not valid environment variable names. Only</translate> {{ctrl.apiObject.kind | humanizeKind}} <translate>keys with valid names will be added as environment variables.</translate>\n" +
    "</div>\n" +
    "</div>\n" +
    "<div class=\"form-group\">\n" +
    ...
    "<translate>Mount path must be a valid path to a directory starting with</translate> <code>/</code>.\n" +
    "</div>\n" +
    "<div class=\"help-block\" ng-show=\"addToApplicationForm.mountVolume.$error.oscUnique\" translate>\n" +
    "The mount path is already used. Please choose another mount path.\n" +
    "</div>\n" +
    "<span class=\"sr-only\" id=\"mount-path-help\">\n" +
    "<translate>Mount Path for the volume. A file will be created in this directory for each key from the</translate> {{ctrl.apiObject.kind | humanizeKind}}.\n" +
    ...
    "{{ctrl.apiObject.kind | humanizeKind}} <translate>will be added to all containers. You can</translate>\n" +
  ...
  $templateCache.put('views/directives/deploy-image.html',
    ...
    "<span class=\"pficon pficon-warning-triangle-o\" aria-hidden=\"true\"></span>\n" +
    "<translate>Service account default will need image pull authority to deploy images from {{istag.namespace}}. You can grant authority with the command:</translate>\n" +
    "<p>\n" +
    ...
    "<div class=\"form-group\">\n" +
    "<label for=\"imageName\" class=\"sr-only\" image name>Image name or pull spec</label>\n" +
    ...
    "<span class=\"sr-only\" image name>Find</span>\n" +
    "</button>\n" +
    "</span>\n" +
    "</div>\n" +
    "<div class=\"help-block\">\n" +
    ...
    "<span class=\"pficon pficon-warning-triangle-o\" aria-hidden=\"true\"></span>\n" +
    "<span translate>Image {{import.name}} runs as the root user which might not be permitted by your cluster administrator.</span>\n" +
    "</div>\n" +
    "<h2>\n" +
    ...
    "</h2>\n" +
    "<p><span translate>Could not find any images for</span> {{import.name | stripTag}}:{{import.tag}}.</p>\n" +
    "</div>\n" +
    "</span>\n" +
    "</div>"
  );
  ...
  $templateCache.put('views/directives/deployment-donut.html',
    ...
    "<translate>View pods for</translate> {{rc | displayName}}\n" +
    "</a>\n" +
    "</div>\n" +
    "\n" +
    ...
    "<span class=\"nowrap\"><translate>min:</translate> {{hpa[0].spec.minReplicas || 1}},</span>\n" +
    "<span class=\"nowrap\">\n" +
    ...
    "<a href=\"\" ng-click=\"unIdle()\"><translate>Start</translate> {{(deploymentConfig || rc) | unidleTargetReplicas : hpa}} pod{{ ((deploymentConfig || rc) | unidleTargetReplicas : hpa) > 1 ? 's' : ''}}</a>\n" +
    "</div>\n" +
    "</div>\n" +
    "</div>"
  );
  ...
  $templateCache.put('views/directives/edit-environment-from.html',
    ...
    "<span class=\"pficon pficon-close\"></span>\n" +
    "</button>\n" +
    "<h1 class=\"modal-title\">{{$ctrl.overlayPaneEntryDetails.kind | humanizeKind : true}} <translate>Details</translate></h1>\n" +
    "</div>\n" +
    "<div class=\"modal-body\">\n" +
    ...
    "{{$ctrl.overlayPaneEntryDetails.kind | humanizeKind}} <translate>has no properties.</translate>\n" +
    "</div>\n" +
  ...
  $templateCache.put('views/directives/edit-environment-variables.html',
    ...
    "<translate>No environment variables set in the</translate> {{$ctrl.apiObject.kind | humanizeKind}}\n" +
    "<translate>template for container {{container.name}}.</translate>\n" +
    "</span>\n" +
  ...
  $templateCache.put('views/directives/edit-lifecycle-hook.html',
    ...
    "</div>\n" +
    "<span>\n" +
    "<a href=\"\" role=\"button\" ng-if=\"!hookParams\" ng-click=\"addHook()\"><translate>Add</translate> {{type | upperFirst}} <translate>Lifecycle Hook</translate></a>\n" +
    "<a href=\"\" role=\"button\" ng-if=\"hookParams\" ng-click=\"removeHook()\"><translate>Remove</translate> {{type | upperFirst}} <translate>Lifecycle Hook</translate></a>\n" +
    "</span>\n" +
    "</ng-form>"
  );
  ...
  $templateCache.put('views/directives/events-sidebar.html',
    ...
    "<span translate>{{event.count}} times in the last</span>\n" +
  ...
  $templateCache.put('views/directives/from-file-dialog.html',
    ...
    "<div class=\"wizard-pf-main-form-contents\">\n" +
    "\n" +
    "<next-steps ng-if=\"$ctrl.currentStep === 'Results | translate'\" project=\"$ctrl.selectedProject\" project-name=\"$ctrl.selectedProject.metadata.name\" login-base-url=\"$ctrl.loginBaseUrl\" on-continue=\"$ctrl.close\" show-project-name=\"$ctrl.showProjectName\" kind=\"$ctrl.kind\" name=\"$ctrl.name\" action-label=\"$ctrl.actionLabel\">\n" +
    "</next-steps>\n" +
    "</div>\n" +
    "</div>\n" +
    "</div>\n" +
  ...
  $templateCache.put('views/directives/lifecycle-hook.html',
    ...
    "<h5 class=\"container-name\"><translate>Container</translate> {{strategyParams[type].execNewPod.containerName}}</h5>\n" +
    "<dl class=\"dl-horizontal left\">\n" +
    ...
    "<h5 class=\"container-name\"><translate>Container</translate> {{tagImage.containerName}}</h5>\n" +
    "<dl class=\"dl-horizontal left\">\n" +
  ...
  $templateCache.put('views/directives/logs/_log-viewer.html',
    ...
    "<a href=\"{{kibanaArchiveUrl}}\" translate>View Archive</a>\n" +
    ...
    "<span class=\"pficon pficon-info\" aria-hidden=\"true\"></span>\n" +
    "<translate>Only the previous</translate> {{options.tailLines || 5000}} <translate>log lines and new log messages will be displayed because of the large log size.</translate>\n" +
    "</div>\n" +
    "\n" +
    "<div ng-if=\"(!state)\">\n" +
  ...
  $templateCache.put('views/directives/next-steps.html',
    ...
    "<translate>You are set up to use the example git repository. If you would like to modify the source code, fork the</translate> <osc-git-link uri=\"$ctrl.createdBuildConfig.spec.source.git.uri\">{{$ctrl.createdBuildConfig.spec.source.git.uri}}</osc-git-link> repository to an OpenShift-visible git account and <a href=\"{{$ctrl.createdBuildConfig | editResourceURL}}\">edit the <strong>{{$ctrl.createdBuildConfig.metadata.name}}</strong> build config</a> to point to your fork.\n" +
  ...
  $templateCache.put('views/directives/osc-form-section.html',
    ...
    "<span class=\"help action-inline\">\n" +
    "<i class=\"pficon pficon-help\"></i>\n" +
    "<a href data-toggle=\"tooltip\" data-original-title=\"{{about}}\"><translate>About</translate> {{aboutTitle}}</a>\n" +
    "</span>\n" +
    "</li>\n" +
    "</ul>\n" +
    "</div>\n" +
  ...
  $templateCache.put('views/directives/osc-image-summary.html',
    ...
    "<div ng-show=\"resource.metadata.namespace && resource.metadata.namespace !=='openshift'\"><translate>Namespace</translate>: {{ resource.metadata.namespace }}</div>\n" +
  ...
  $templateCache.put('views/directives/osc-persistent-volume-claim.html',
    ...
    "<translate>Access</translate>: {{sclass | storageClassAccessMode}}\n" +
    "</span>\n" +
    ...
    "<span class=\"help-block\">\n" +
    "<translate>Can't be less than</translate> {{limits.min | usageWithUnits : 'storage'}}.\n" +
    "</span>\n" +
    "</div>\n" +
    "<div ng-if=\"persistentVolumeClaimForm.capacity.$error.limitRangeMax\" class=\"has-error\">\n" +
    "<span class=\"help-block\">\n" +
    "<translate>Can't be greater than</translate> {{limits.max | usageWithUnits : 'storage'}}.\n" +
    "</span>\n" +
    "</div>\n" +
  ...
  $templateCache.put('views/directives/pause-rollouts-checkbox.html',
    ...
    "<translate>Pause rollouts for this </translate>{{deployment.kind | humanizeKind}}\n" +
    "</label>\n" +
  ...
  $templateCache.put('views/edit/autoscaler.html',
    ...
    "<span class=\"pficon pficon-warning-triangle-o\" aria-hidden=\"true\"></span>\n" +
    "<span class=\"sr-only\" translate>Warning:</span>\n" +
    "{{targetKind | humanizeKind}} <translate>does not have any containers with a CPU</translate>\n" +
  ...
  $templateCache.put('views/edit/build-config.html',
    ...
    "<div class=\"help-block\" ng-switch-default><translate>Builds triggered from this Build Configuration will run using the</translate> {{updatedBuildConfig.spec.runPolicy | sentenceCase}} <translate>policy</translate>.</div>\n" +
    "</div>\n" +
    "</div>\n" +
    "<div ng-if=\"!(updatedBuildConfig | isJenkinsPipelineStrategy)\" class=\"section\">\n" +
    "\n" +
  ...
  $templateCache.put('views/edit/config-map.html',
    ...
    "<breadcrumbs breadcrumbs=\"breadcrumbs\"></breadcrumbs>\n" +
    "<div class=\"mar-top-xl\">\n" +
    "<h1><translate>Edit Config Map</translate> {{configMap.metadata.name}}</h1>\n" +
    "<div class=\"help-block\" translate>\n" +
    "Config maps hold key-value pairs that can be used in pods to read application configuration.\n" +
    "</div>\n" +
    "<div class=\"mar-top-xl\">\n" +
  ...
  $templateCache.put('views/edit/deployment-config.html',
    ...
    "<div ng-if=\"loaded\">\n" +
    "<h1>\n" +
    "<translate>Edit Deployment Config </translate> {{deploymentConfig.metadata.name}}\n" +
    "</h1>\n" +
    "<fieldset ng-disabled=\"disableInputs\">\n" +
    ...
    "<div class=\"form-group\">\n" +
    "<label translate>Environment Variables</label>\n" +
    "<key-value-editor entries=\"strategyData.customParams.environment\" key-validator=\"[-._a-zA-Z][-._a-zA-Z0-9]*\" key-validator-error-tooltip=\"{{'A valid environment variable name must consist of alphabetic characters, digits, '_', '-', or '.', and must not start with a digit.' | translate}}\" value-from-selector-options=\"valueFromObjects\" add-row-link=\"Add Value\" add-row-with-selectors-link=\"{{'Add Value from Config Map or Secret' | translate}}\"></key-value-editor>\n" +
    "</div>\n" +
    "</div>\n" +
    "<div ng-if=\"strategyData.type !== 'Custom'\">\n" +
    "<div class=\"form-group\">\n" +
    ...
    "<h4><translate>Container</translate> {{containerName}}</h4>\n" +
    "</div>\n" +
  ...
  $templateCache.put('views/edit/jenkinsfile-examples.html',
    ...
    "</p>\n" +
    "<p>\n" +
    "<translate>Checkout source code and run shell commands on a node labelled 'maven':</translate>\n" +
  ...
  $templateCache.put('views/images.html',
    ...
    "<translate>and</translate> {{imageStream.status.tags.length - 4}} <translate>others</translate></span>\n" +
    "</td>\n" +
  ...
  $templateCache.put('views/membership.html',
    ...
    "<div class=\"action-set\">\n" +
    "<div class=\"col-roles\">\n" +
    "<action-chip ng-repeat=\"role in subject.roles\" key=\"role.metadata.name\" key-help=\"roleHelp(role)\" show-action=\"mode.edit\" action=\"confirmRemove(subject.name, subjectKind.name, role.metadata.name, subject.namespace)\" action-title=\"'Remove role {{role.metadata.name}} from {{subject.name}}' | translate\"></action-chip>\n" +
    "</div>\n" +
    "<div ng-if=\"mode.edit\" class=\"col-add-role\">\n" +
    "<div class=\"col-add-role-inputs\">\n" +
    "<ui-select ng-if=\"filteredRoles.length\" ng-model=\"subject.newRole\" theme=\"bootstrap\" search-enabled=\"true\" title=\"'Select a new role for {{subject.name}}' | translate\" class=\"select-role\">\n" +
    ...
    "<ui-select ng-model=\"newBinding.namespace\" on-select=\"selectProject($item, $model)\" theme=\"bootstrap\" search-enabled=\"true\" title=\"{{'Select a project' | translate}}\" class=\"select-project\">\n" +
    ...
    "<ui-select ng-model=\"newBinding.name\" theme=\"bootstrap\" search-enabled=\"true\" title=\"{{'Select a service account' | translate}}\" class=\"select-service-account\">\n" +
  ...
  $templateCache.put('views/modals/about-compute-units-modal.html',
    ...
    "<h3>CPU</h3>\n" +
    "<p>\n" +
    "<translate>CPU is often measured in units called 'millicores'. Each millicore is equivalent to </translate>\n" +
    "<sup>1</sup>&frasl;<sub>1000</sub> of a CPU&nbsp;core.\n" +
    "</p>\n" +
    "<pre>\n" +
    ...
    "<p>\n" +
    "<translate>Memory and storage are measured in binary units like </translate><var>KiB</var>, <var>MiB</var>, <var>GiB</var>, and <var>TiB</var>\n" +
    "<translate>or decimal units like</translate> <var>kB</var>, <var>MB</var>, <var>GB</var>, and&nbsp;<var>TB</var>.\n" +
    "</p>\n" +
    "<div class=\"row\">\n" +
    "<div class=\"col-sm-6\">\n" +
  ...
  $templateCache.put('views/modals/confirm-save-log.html',
    ...
    "</div>\n" +
    "<div class=\"modal-body\">\n" +
    "<p translate>Save partial log for {{object.metadata.name}}?</p>\n" +
  ...
  $templateCache.put('views/modals/confirmScale.html',
    ...
    "</div>\n" +
    "<div class=\"modal-body\">\n" +
    "<p><translate>Scale down</translate> {{type}} <strong>{{resource | displayName}}</strong>?</p>\n" +
    "<p>\n" +
    "<translate>Are you sure you want to scale</translate> {{resource | displayName}}\n" +
    "<translate>to 0 replicas? This will stop all pods for the {{type}}.</translate>\n" +
    "</p>\n" +
    "</div>\n" +
    "<div class=\"modal-footer\">\n" +
    "<button class=\"btn btn-default\" type=\"button\" ng-click=\"cancel()\" translate>Cancel</button>\n" +
  ...
  $templateCache.put('views/modals/delete-resource.html',
    ...
    "</div>\n" +
    "<div class=\"modal-body\">\n" +
    "<p><translate>Are you sure you want to delete the</translate> {{typeDisplayName || (kind | humanizeKind)}} '<strong>{{displayName ? displayName : resourceName}}</strong>'?</p>\n" +
    "<p>\n" +
    ...
    "<translate>This will delete the</translate> {{typeDisplayName || (kind | humanizeKind)}} <translate>and any running pods.</translate>\n" +
    "</span>\n" +
    "<span ng-if=\"kind === 'ServiceInstance'\">\n" +
    "{{displayName ? displayName : resourceName}} <translate>and its data will no longer be available to your applications.</translate>\n" +
    "</span>\n" +
    "<span ng-if=\"isProject\">\n" +
    "<translate>This will 'delete all resources' associated with the </translate> {{displayName ? displayName : resourceName}}<translate>project</translate>.\n" +
    "</span>\n" +
    "<strong translate>It cannot be undone.</strong> <translate>Make sure this is something you really want to do!</translate>\n" +
    "</p>\n" +
    "<div ng-show=\"typeNameToConfirm\">\n" +
    "<p> <translate>confirm</translate> {{typeDisplayName || (kind | humanizeKind)}} <translate>Type name</translate>.</p>\n" +
    "<p>\n" +
    "<label class=\"sr-only\" for=\"resource-to-delete\"><translate>delete</translate>{{typeDisplayName || (kind | humanizeKind)}}</label>\n" +
  ...
  $templateCache.put('views/modals/process-or-save-template.html',
    ...
    "<span class=\"pficon pficon-close\"></span>\n" +
    "</button>\n" +
    "<h1 class=\"modal-title\" ng-if=\"updateTemplate\" translate>Update Template</h1>\n" +
    "<h1 class=\"modal-title\" ng-if=\"!updateTemplate\" translate>Add Template</h1>\n" +
    "</div>\n" +
    "<div class=\"modal-body\">\n" +
    ...
    "<strong ng-if=\"updateTemplate\" translate>Update Template</strong>\n" +
    "<strong ng-if=\"!updateTemplate\" translate>Add Template</strong>\n" +
    "</label>\n" +
    "<div id=\"save-template-help\" class=\"help-block\" ng-if=\"updateTemplate\" translate>\n" +
    "This will overwrite the current version of the template.\n" +
    "</div>\n" +
    "<div id=\"save-template-help\" class=\"help-block\" ng-if=\"!updateTemplate\" translate>\n" +
  ...
  $templateCache.put('views/modals/set-home-page-modal.html',
    ...
    "<translate>Overview Page for</translate>{{availableProjects.length === 1 ? ' ' + (selectedProject | displayName) : ':'}}\n" +
    "</label>\n" +
  ...
  $templateCache.put('views/newfromtemplate.html',
    ...
    "<translate>from parameters</translate>\n" +
  ...
  $templateCache.put('views/other-resources.html',
    ...
    "<div ng-if=\"!filterWithZeroResults\">\n" +
    "<h2><translate>No</translate> {{resourceName}}.</h2>\n" +
    "<p translate>\n" +
  ...
  $templateCache.put('views/overview.html',
    ...
    "<div ng-if=\"project.metadata.name | canIAddToProject\">\n" +
    "<p>\n" +
    "<span translate>pipelines have been added to project {{projectName}}.</span>\n" +
    "<br>\n" +
    "<translate>Learn more about</translate>\n" +
    "<a ng-href=\"{{ 'pipeline-builds' | helpLink}}\" target=\"_blank\">Pipeline Builds</a>\n" +
    "<translate>and the</translate>\n" +
  ...
  $templateCache.put('views/overview/_builds.html',
    ...
    "<span ng-switch=\"build.status.phase\" class=\"hide-ng-leave\">\n" +
    "<span ng-switch-when=\"Failed\" translate>failed</span>\n" +
    "<span ng-switch-when=\"Error\"> translateencountered an error</span>\n" +
    "<span ng-switch-when=\"Cancelled\" translate>was cancelled</span>\n" +
  ...
  $templateCache.put('views/pipelines.html',
    ...
    "<translate>Average Duration</translate>: {{statsByConfig[buildConfigName].avgDuration | timeOnlyDuration}}\n" +
    "</div>\n" +
    "<h4>\n" +
  ...
  $templateCache.put('views/projects.html',
    ...
    "<span ng-if=\"project | annotation : 'openshift.io/requester'\"> <span ng-bind-html=\"project | annotation : 'openshift.io/requester' | highlightKeywords : keywords\"></span></span>\n" +
  ...
  $templateCache.put('views/quota.html',
    ...
    "<h3 class=\"text-center\"><translate>CPU</translate> <small translate>Request</small></h3>\n" +
    ...
    "<h3 class=\"text-center\"><translate>CPU</translate> <small translate>Limit</small></h3>\n" +
  ...
  $templateCache.put('views/storage.html',
    ...
    "<span ng-if=\"pvc | storageClass\" class=\"text-muted\"> <translate>using</translate> {{pvc | storageClass}} <translate>storage class</translate></span>\n" +
    "</td>\n" +
    "<td data-title=\"Status\">\n" +
    "<status-icon status=\"pvc.status.phase\" disable-animation></status-icon>\n" +
    "{{pvc.status.phase}}\n" +
  ...
  $templateCache.put('views/util/error.html',
    ...
    "</div>\n" +
    "<br>\n" +
    "<div><translate>Return to the</translate> <a href=\"\" ng-click=\"reloadConsole()\">console</a>.</div>\n" +
    "</div>\n" +
    "</div>\n" +
    "</div>"
  );
  ...
  $templateCache.put('views/util/oauth.html',
    ...
    "<p><translate>You are about to change users from</translate>You are about to change users from <code>{{overriddenUser.metadata.name}}</code> <translate>to</translate> <code>{{confirmUser.metadata.name}}</code>.</p>\n" +
