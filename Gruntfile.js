          ...
          middleware: function (connect) {
            return [
              modRewrite([
                '^/$ /' + contextRoot + '/ [R=302]',
                '^/' + contextRoot + '(.*)$ $1',
                '!^/(config.js|(java|bower_components|scripts|images|styles|views|components|languages)(/.*)?)$ /index.html [L]'
              ]),
              serveStatic('.tmp'),
              connect().use(
                '/java',
        ...
        options: {
          ...
          middleware: function (connect) {
            var rewriteRules = [
              ...
              '^/$ /' + contextRoot + '/ [R=302]',
              '^/' + contextRoot + '(.*)$ $1',
              '!^/(config.js|(bower_components|scripts|images|styles|views|extensions|components|languages)(/.*)?)$ /index.html [L]'
            ];
