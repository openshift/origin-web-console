      ...
      it('should process and create the objects in the template', () => {
        ...
        catalogPage
          ...
          .then((createFromTemplatePage) => {
            ...
            matchers.expectElementToBeVisible(element(by.cssContainingText('td a', 'mongodb')));
            matchers.expectElementToBeVisible(element(by.cssContainingText('td a', 'nodejs-mongodb-example')));
